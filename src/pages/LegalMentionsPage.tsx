    ...
    <div ref={containerRef} className="relative min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            >
              ...
              <span className="text-white/80">Informations légales et réglementaires</span>
            </motion.div>
            ...
            >
              Retrouvez toutes les informations légales concernant SENFRANCE, l'éditeur du site, l'hébergement 
              et la propriété intellectuelle conformément à la législation française.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 flex items-start gap-4">
              ...
              <div>
                <h3 className="text-blue-900 font-semibold mb-2">Conformité légale</h3>
                <p className="text-blue-800">
                  Ces mentions légales respectent les obligations de la loi française pour la confiance dans l'économie numérique (LCEN) 
                  et fournissent toutes les informations requises sur l'identité de l'éditeur du site.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Questions juridiques ?</h3>
                <p className="text-gray-600">
                  Pour toute question relative aux mentions légales ou à l'utilisation du site, contactez notre équipe.
                </p>
              </div>
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h3 className="text-2xl font-bold mb-8 text-gray-900">Documents associés</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <h4 className="font-semibold mb-2 text-gray-900 text-lg">Conditions Générales d'Utilisation</h4>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Consultez les conditions qui régissent l'utilisation de notre site et de nos services
                </p>
                <a 
                  href="/terms" 
              ...
              >
                ...
                <h4 className="font-semibold mb-2 text-gray-900 text-lg">Politique de Confidentialité</h4>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Découvrez notre engagement en matière de protection des données personnelles
                </p>
                <a 
                  href="/privacy" 
