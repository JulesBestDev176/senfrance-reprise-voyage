...
const timeline = [
  {
    ...
    description:
      "Fondation de l'entreprise avec une vision moderne et globale des services aux étudiants en mobilité.",
    icon: "🚀",
    color: "rose",
  },
  {
    ...
    description:
      "Développement de notre gamme complète d'assurances et de services financiers avec nos partenaires.",
    icon: "🛡️",
    color: "purple",
  },
  {
    ...
    description:
      "Mise en place d'un réseau de logements de qualité adaptés aux besoins des étudiants et jeunes professionnels.",
    icon: "🏠",
    color: "indigo",
  },
  {
    ...
    description:
      "Lancement des plateformes digitales SENFRANCE.com et Perfectible.sn pour un meilleur suivi de nos étudiants.",
    icon: "🌐",
    color: "amber",
  },
  {
    ...
    description:
      "Diversification de nos services et expansion vers de nouveaux marchés.",
    icon: "⭐",
    color: "rose",
  },
];
  ...
  return (
    <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/80 mb-6 leading-relaxed">
                SENFRANCE accompagne les{" "}
                <span className="font-semibold text-[#FFC3BC]">étudiants</span>{" "}
                en mobilité dans leurs projets le plus importants avec une
                approche{" "}
                <span className="font-semibold text-[#FFC3BC]">
                  personnalisée et innovante
                </span>
                .
              </p>
              <p className="text-lg text-white/80 mb-10 leading-relaxed">
                ...
                <span className="font-semibold text-[#FFC3BC]">
                  Hébergement, AVI & Assurances, Job Étudiant et Assistance
                </span>{" "}
                - forment un écosystème complet pour votre réussite.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <Button
                    asChild
                    className="bg-gradient-to-r from-[#FFC3BC] to-[#ff9d94] text-[#18133E] hover:from-[#ff9d94] hover:to-[#FFC3BC] rounded-full px-8 py-6 text-lg font-medium border-0"
                  >
              ...
              <div className="relative">
                ...
                >
                  ...
                  <p className="text-white/80 mb-4">
                    Nous révolutionnons la mobilité étudiante avec :
                  </p>
                ...
                >
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 text-center">
                    <div className="text-2xl font-bold text-[#FFC3BC] mb-1">
                      2000+
                    </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#18133E]">
              Quatre domaines d'expertise pour ta réussite
            </h2>
            <div
            ...
            <p className="text-gray-600">
              Une approche intégrée qui couvre tous vos les besoins, de la
              recherche de logement au job étudiant .
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Hébergement",
                description:
                  "Solutions de logement de qualité adaptées aux étudiants et jeunes professionnels",
                color: "rose",
                features: [
                  "Logements vérifiés",
                  "Aide aux démarches",
              ...
              },
              {
                ...
                description:
                  "Caution pour études et assurances diverses pour une protection optimale",
                color: "purple",
                features: [
                  "Couverture mondiale",
                  "Assistance 24h/24",
              ...
              },
              {
                ...
                description:
                  "Plateforme de mise en relation pour stages et emplois compatibles avec tes études",
                color: "indigo",
                features: [
              ...
              },
              {
                ...
                description:
                  "Support personnalisé et conseils d'experts dans tous nos domaines d'intervention",
                color: "amber",
                features: [
                  "Conseiller dédié",
                  "Suivi personnalisé",
              ...
              return (
                <div
                  ...
                  className={`group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border ${style.border} ${style.hover} h-full relative overflow-hidden hover:-translate-y-2 hover:scale-105`}
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${style.icon} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}
                  ></div>

                  <div
                    className={`w-14 h-14 mb-4 rounded-xl bg-gradient-to-br ${style.icon} flex items-center justify-center text-white relative z-10 transition-transform duration-500 ${
                  ...
                  <div className="space-y-1 relative z-10">
                    {service.features.map((feature, idx) => (
                      ...
                      >
                        <div
                          className={`w-1.5 h-1.5 rounded-full bg-gradient-to-r ${style.icon} mr-2`}
                        ></div>
                        {feature}
                      </div>
                    ))}
                  ...
                  <div
                    className={`mt-4 h-0.5 bg-gradient-to-r ${style.icon} rounded-full relative z-10 transition-all duration-500`}
                    style={{
                      width: activeFeature === index ? "100%" : "20%"
                    }}
                  />
                </div>
              );
      ...
      <section className="py-8 bg-[#18133E] text-white relative overflow-hidden">
        ...
        {/* Commented out team section - can be re-enabled if needed */}
        <div className="container mx-auto px-4 relative z-10">
          <div
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Comment SenFrance est née
            </h2>
            <div
              className="h-1 bg-gradient-to-r from-[#FFC3BC] to-transparent rounded-full mx-auto mb-8"
              style={{ width: "5rem" }}
            />
          </div>
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/20 relative overflow-hidden">
              {/* Decorative elements */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFC3BC]/10 rounded-full blur-2xl"></div>
              <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/5 rounded-full blur-xl"></div>

              <div className="relative z-10">
                <div
                  className="prose prose-lg text-white/90 max-w-none"
                >
                  <p className="text-lg md:text-xl leading-relaxed mb-6 first-letter:text-5xl first-letter:font-bold first-letter:text-[#FFC3BC] first-letter:float-left first-letter:leading-none first-letter:mr-2 first-letter:mt-1">
                    <strong className="text-[#FFC3BC]">
                      SenFrance est née de la volonté de ses associés et d'une
                      idée simple :
                    </strong> 
                    offrir un service dont nous n'avions pas pu bénéficier en
                    tant qu'étudiants internationaux dans une société et une
                    culture nouvelles.
                  </p>

                  <p className="text-lg leading-relaxed mb-6">
                    Nous sommes persuadés que la cause principale de l'échec
                    chez beaucoup d'étudiants (qu'ils viennent de loin ou non)
                    tient aux 
                    <span className="text-[#FFC3BC] font-semibold">
                      conditions de vie
                    </span>
                    . Notre engagement est donc né d'un constat sans appel :{" "}
                    <strong>un besoin réel existe sans solution adaptée</strong>
                    .
                  </p>
                  ...
                  <p className="text-lg leading-relaxed mb-6">
                    ...
                    <span className="text-[#FFC3BC] font-semibold">
                      le partenaire de l'étudiant
                    </span>
                    . Nos solutions sur mesure seront pour lui un bâton de
                    pèlerin. Nous travaillons avec des organisations, des
                    particuliers et des entreprises pour fournir un service de
                    qualité.
                  </p>

                  <p
                    className="text-xl font-semibold text-center p-6 bg-[#FFC3BC]/10 rounded-2xl border border-[#FFC3BC]/20 mt-8"
                  >
                    <span className="text-[#FFC3BC]">
                      Vous êtes évidemment en quête de stabilité pendant vos
                      études.
                    </span>
                    <br />
                    <span className="text-white">
                      Nous sommes ravis de vous y aider.
                    </span>
                  </p>
                </div>
                ...
                >
                  <div className="text-center">
                    <div className="w-16 h-16 bg-[#FFC3BC]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                      <Heart className="w-8 h-8 text-[#FFC3BC]" />
                    </div>
                    <h4 className="font-semibold text-white mb-2">
                      Expérience Vécue
                    </h4>
                    <p className="text-white/70 text-sm">
                      Fondé par d'anciens étudiants internationaux
                    </p>
                  </div>

                  <div className="text-center">
                    <div className="w-16 h-16 bg-[#FFC3BC]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                      <Users className="w-8 h-8 text-[#FFC3BC]" />
                    </div>
                    <h4 className="font-semibold text-white mb-2">
                      Partenariat
                    </h4>
                    <p className="text-white/70 text-sm">
                      Votre allié tout au long de vos études
                    </p>
                  </div>

                  <div className="text-center">
                    <div className="w-16 h-16 bg-[#FFC3BC]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                      <Target className="w-8 h-8 text-[#FFC3BC]" />
                    </div>
                    <h4 className="font-semibold text-white mb-2">
                      Solutions Sur Mesure
                    </h4>
                    <p className="text-white/70 text-sm">
                      Des services adaptés à vos besoins uniques
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-8 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            />
            <p className="text-gray-600">
              Découvrez les étapes clés qui ont façonné notre entreprise et
              notre vision.
            </p>
          </div>
              ...
              {timeline.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div
                        className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-105"
                      >
                    ...
                    <div className="w-2/12 flex justify-center">
                      <div
                        className={`w-14 h-14 rounded-full bg-gradient-to-br ${style.icon} flex items-center justify-center text-white font-bold text-sm shadow-lg transition-transform duration-200 hover:scale-110`}
                      >
                        {item.year}
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Rejoignez les centaines d'étudiants et parents d'élèves qui nous
              font confiance pour leur projet de mobilité vers la France.
            </p>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              >
                <Button
                  asChild
                  className="bg-gradient-to-r from-[#18133E] to-[#271D5B] hover:from-[#271D5B] hover:to-[#18133E] text-white rounded-full px-8 py-6 text-lg font-medium"
                >
                  <Link to="/contact" className="flex items-center gap-2">
              ...
              >
                <Button
                  asChild
                  variant="outline"
                  className="text-[#18133E] border-[#18133E]/20 hover:bg-[#18133E]/5 rounded-full px-8 py-6 text-lg font-medium"
                >
                  <Link to="/services">
                    <span>Découvrir nos services</span>
                  </Link>
