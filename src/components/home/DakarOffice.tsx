        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <ButtonEffect color="secondary">
                <a
                  href="https://api.whatsapp.com/message/3EL3Z6GKPQIQE1?autoload=1&app_absent=0"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#FFC3BC]/10 text-[#18133E] font-medium py-2.5 px-5 rounded-full"
                >
          ...
          >
            ...
            <motion.div
              ...
              animate={{
                borderColor: mapHovered
                  ? "rgba(255, 195, 188, 0.6)"
                  : "rgba(255, 195, 188, 0.4)",
              }}
            />
    ...
    >
      <motion.div
        className={`p-3 rounded-xl ${
          isHovered ? style.dark : style.light
        } transition-all duration-300 mr-3 mt-1`}
        animate={
          isHovered
      ...
      >
        {React.cloneElement(icon, {
          className: `h-5 w-5 ${
            isHovered ? "text-white" : style.text
          } transition-colors duration-300`,
        })}
      </motion.div>
      <div>
        <div className="flex items-center gap-2">
          <h3 className="text-lg font-semibold text-[#18133E] mb-1 group-hover:text-[#271D5B] transition-colors duration-300">
            {title}
          </h3>
          <AnimatePresence>
            {isHovered && (
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={
          isHovered ? { opacity: 0.8, scale: 1.05 } : { opacity: 0, scale: 1 }
        }
        transition={{ duration: 0.3 }}
      />
      {children}
